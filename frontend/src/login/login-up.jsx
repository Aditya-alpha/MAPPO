    ...
    async function updatePassword(e) {
        ...
        try {
            ...
            if (response.status === 200) {
                window.localStorage.removeItem("email")
                alert("Password updated successfully! Now you can login using your new password.")
                navigate("/login")
            } else {
                    ...
                    <div>
                        ...
                        <div className="mt-24">
                            ...
                            <p className="mt-8 max-w-sm text-sm leading-7 text-white/40">
                                Choose a strong new password to protect your
                                MAPPO account and get back to exploring.
                            </p>
                ...
                <div className="relative p-7 sm:p-10 lg:p-12 xl:p-16">
                    ...
                    <div className="mt-16 lg:mt-12">
                        ...
                        <p className="mt-4 text-sm leading-7 text-white/40">
                            Create a new password for your MAPPO account.
                        </p>
