...
export default function ForgotPassword() {
    ...
    async function sendOtp() {
        try {
            const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/login/forgotpassword`, {
                method: "POST",
                headers: {
    ...
    return (
        <div className="h-screen w-full flex justify-center items-center bg-[#1db1ff]">
            <div className="h-60 w-[600px] rounded-lg py-6 px-5 bg-sky-300 shadow-2xl hover:scale-105 transition-all duration-300 max-lg:mx-4">
