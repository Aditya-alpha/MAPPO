    ...
    async function updatePassword(e) {
        ...
        try {
            const response = await fetch(
                `${import.meta.env.VITE_BACKEND_URL}/login/updatepassword`,
                {
                    method: "POST",
                    headers: {
                    ...
                    <div>
                        ...
                        <div className="mt-24">
                            ...
                            <p className="mt-8 max-w-sm text-sm leading-7 text-white/40">
                                ...
                                password to regain secure access to your MAPPO
                                account.
                            </p>
                ...
                <div className="relative p-7 sm:p-10 lg:p-12 xl:p-16">
                    ...
                    <div className="mt-16 lg:mt-12">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex h-12 w-12 items-center justify-center border border-cyan-400/20 bg-cyan-400/[0.04] text-cyan-400">
                                <FaLock />
                            </div>
                        ...
                        <p className="mt-4 text-sm leading-7 text-white/40">
                            Choose a strong password for your MAPPO account.
                        </p>
                        ...
                        >
                            ...
                            <div className="mt-6 border border-white/[0.08] bg-white/[0.02] p-4">
                                ...
                                <p className="text-xs leading-6 text-white/30">
                                    ...
                                    8 characters. Avoid using easily guessed
                                    information.
                                </p>
