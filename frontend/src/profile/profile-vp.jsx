...
export default function VerifyProfileOtp() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            const response = await fetch(`${process.env.BACKEND_URL}/login/forgotpassword/verify`, {
                method: "POST",
                headers: {
    ...
    return (
        <div className="h-screen w-full flex justify-center items-center bg-[#1db1ff]">
            <div className="h-96 w-[420px] rounded-lg py-4 px-5 bg-sky-300 shadow-2xl hover:scale-105 transition-all duration-300 max-sm:mx-4">
